...
const SocMedLinks = () => {
    return (
        <div className='flex gap-2'>
            <button className="btn bg-[#1A77F2] text-white border-[#005fd8] h-8 w-fit rounded-full px-3 flex items-center gap-2 hover:scale-115 transition-all duration-200 active:scale-105">
            ...
            <button className="btn bg-[#dd3ab8] text-white border-[#dd3ab8] h-8 w-fit rounded-full px-3 flex items-center gap-2 hover:scale-115 transition-all duration-200 active:scale-105">
            ...
            <button className="btn bg-[#14A800] text-white border-[#0B6A0B] h-8 w-fit rounded-full px-3 flex items-center gap-2 hover:scale-115 transition-all duration-200 active:scale-105">
            ...
            <button className="btn bg-[#3A3D41] text-white border-[#2F3136] h-8 w-fit rounded-full px-3 flex items-center gap-2 hover:scale-115 transition-all duration-200 active:scale-105">
